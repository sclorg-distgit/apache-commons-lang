%{?scl:%scl_package apache-commons-lang}
...
Provides:       %{?scl_prefix}jakarta-commons-lang = 0:%{version}-%{release}
Obsoletes:      %{?scl_prefix}jakarta-commons-lang <= 0:2.4
...
Group:          Documentation
Obsoletes:      %{?scl_prefix}jakarta-%{short_name}-javadoc <= 0:2.4
...
%changelog
* Tue Jan 21 2014 Stanislav Ochotnicky <sochotnicky@redhat.com> - 2.6-14.2
- Rebuild to fix provides/requires

* Tue Nov 12 2013 Michal Srb <msrb@redhat.com> - 2.6-14.1
